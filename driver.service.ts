...
export class DriverService {
  ...
  getDriverList(): Observable<Driver[]>{
    console.log("buslist");
    return this.httpClient.get<Driver[]>(`${this.baseURL}/AllDriver`);
  }
  ...
  getDriverDetailsById(driverId: number): Observable<Driver>{
    ...
    return this.httpClient.get<Driver>(`${this.baseURL}/Driver/${driverId}`);
  }

  updateDriverDetailsById(driverId: number, driver: Driver): Observable<Object>{
    return this.httpClient.put(`${this.baseURL}/updateBus/${driverId}`,driver);
  }
